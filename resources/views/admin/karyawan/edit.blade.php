            ...
            <div class="card-body">
              <form action="{{ route('karyawan.update', $karyawan->id) }}" method="POST">
                ...
                <div class="row mb-3">
                  ...
                  <div class="col-sm-10">
                    <input type="text" name="nama_karyawan" class="form-control" id="basic-default-name" placeholder="Masukan nama!" value="{{ old('nama_karyawan', $karyawan->nama_karyawan) }}"/>
                  </div>
                </div>
                <div class="row mb-3">
                ...
                <div class="row mb-3">
                  ...
                  <div class="col-sm-10">
                    <select name="jenis_kelamin" class="form-control">
                        ...
                        <option value="Laki-laki" {{ $karyawan->jenis_kelamin ? 'selected' : '' }}>Laki-laki</option>
                        <option value="Perempuan" {{ $karyawan->jenis_kelamin ? 'selected' : '' }}>Perempuan</option>
                    </select>
                  </div>
                </div>
                <div class="row mb-3">
                  ...
                  <div class="col-sm-10">
                    <input type="email" name="email" class="form-control" id="basic-default-name" placeholder="Masukan Email!" required="email"  value="{{ old('nama_karyawan', $karyawan->email) }}"/>
                  </div>
                </div>
                <div class="row mb-3">
